            ...
            <div className="timeline-item">
              ...
              <div className="content-desc">
                <p className="desc-title">
                  <b>백제예술대학교</b>
                  <span className="desc-detail">실내디자인과</span>
                </p>
              </div>
            </div>
            <div className="timeline-item">
              ...
              <div className="content-desc">
                <p className="desc-title">
                  <b>평촌과학기술고등학교</b>
                  <span className="desc-detail">디지털산업디자인과</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="timeline-list">
            <div className="timeline-item">
              ...
              <div className="content-desc">
                <p className="desc-title">
                  ...
                  <span className="desc-detail">대한상공회의소</span>
                </p>
              </div>
            </div>
            <div className="timeline-item">
              ...
              <div className="content-desc">
                <p className="desc-title">
                  ...
                  <span className="desc-detail">한국생산성본부</span>
                </p>
              </div>
            </div>
            <div className="timeline-item">
              ...
              <div className="content-desc">
                ...
                <div className={`detail-block ${isOpen0 ? "is-open" : ""}`}>
                  ...
                  <ul className="detail-content">
                    <li className="detail-item">엑셀</li>
                    <li className="detail-item">파워포인트</li>
                    <li className="detail-item">한글</li>
                    <li className="detail-item">인터넷</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="timeline-item">
              ...
              <div className="content-desc">
                <p className="desc-title">
                  <b>디지털정보활용능력</b>
                  <span className="desc-detail">(사)한국정보통신진흥협회</span>
                </p>
              </div>
            </div>
            <div className="timeline-item">
