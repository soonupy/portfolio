...
const ScrollToTopbtn = () => {
    ...
    return (
        <button className="nav-control-btn" data-tooltip-id="scroll-to-top" data-tooltip-content="scroll to top" onClick={() => scrollToTop()}>
            <i className="icon ico-md"><ChevronUp strokeWidth={4} /></i>
        </button>
    );
};
        ...
        <section className={`navigation-section`}>
            <nav className="list-bar nav-bar">
                ...
                <ul className="list nav-list">
                    ...
                    <li className="nav-page-item">
                        <input type="radio" id="project" name="nav-section" value="project"/>
